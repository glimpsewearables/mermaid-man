...
<html lang="en">
<head>
    <title>Code coverage report for Gallery.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> Gallery.js
    </h1>
    <div class='clearfix'>
...
class Gallery extends React.Component {
  ...
  componentDidMount() {
    this.observer = new ResizeObserver(<span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      this.setState({ containerWidth: Math.floor(this._gallery.clientWidth) });</span>
    });
  ...
  handleClick = (event, { index }) =&gt; {
    ...
    onClick(event, {
      ...
      next: photos[index + 1] || <span class="branch-1 cbranch-no" title="branch not covered" >null,</span>
    });
  };
&nbsp;
  render() {
...
&nbsp;
    ...
    if (columns === undefined) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (containerWidth &gt;= 1500) <span class="cstat-no" title="statement not covered" >columns = 4;</span>
    }
